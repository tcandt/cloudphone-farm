  ...
  return (
    <div className="min-h-screen bg-white text-pcp-text flex flex-col font-sans antialiased">
      ...
      <div className="flex flex-1 relative min-h-[calc(100vh-61px)] overflow-hidden bg-white">
        ...
        <main
          className={`flex-1 p-5 md:p-6 overflow-y-auto min-w-0 bg-[#f3f4f8] transition-all duration-300 animate-fadeIn ${!isSidebarCollapsed ? 'rounded-tl-3xl shadow-inner' : ''
            }`}
        >
          <Outlet />
        </main>
