        ...
        {!isHttpMode ? (
            ...
            <div className="flex justify-center">
              ...
              >
                <svg className="w-4 h-4" viewBox="0 0 24 24">
                  ...
                  <path fill="#34A853" d="M12 24c3.24 0 5.95-1.08 7.93-2.91l-3.88-3.05c-1.08.72-2.45 1.16-4.05 1.16-3.12 0-5.77-2.11-6.72-4.96H1.26v3.15C3.25 21.31 7.31 24 12 24z" />
                  ...
                  <path fill="#EA4335" d="M12 4.75c1.77 0 3.35.61 4.6 1.8l3.42-3.42C17.95 1.19 15.24 0 12 0 7.31 0 3.25 2.69 1.26 6.61l4.02 3.15c.95-2.85 3.6-4.96 6.72-4.96z" />
                </svg>
          ...
          <div className="p-3 bg-amber-50 border border-amber-200 rounded-xl text-center">
            <p className="text-[11px] text-amber-800 font-medium">
              Enterprise Dev Authority: <span className="font-mono font-bold">owner@phonecontrol.io</span> / <span className="font-mono font-bold">pcp_secure_pass_2026</span>
            </p>
          </div>
        )}
