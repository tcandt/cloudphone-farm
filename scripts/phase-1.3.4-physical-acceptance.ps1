...
try {
    cmd /c "if exist `"C:\Program Files\Android\Android Studio\jbr\bin\java.exe`" (set JAVA_HOME=C:\Program Files\Android\Android Studio\jbr) & gradlew.bat assembleDebug --no-daemon"
} finally {
    Pop-Location
}
